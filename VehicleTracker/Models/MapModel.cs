...
namespace ThinkGeo.MapSuite.VehicleTracker
{
    public class MapModel
    {
        ...
        private static Cursor handCursor = new Cursor(Application.GetResourceStream(new Uri("/MapSuiteVehicleTracker;component/Image/cursor_hand.cur", UriKind.RelativeOrAbsolute)).Stream);
